...
import image5 from "../../../Gallery/Group 15.png"
import image6 from "../../../Gallery/Group 16.png"
import image7 from "../../../Gallery/Group 17.png"
import image8 from "../../../Gallery/Group 18.png"
...
<div className="font-sans max-w-5xl max-md:max-w-xl mx-auto bg-white py-4">
    ...
    />                                </div>
                            ...
                            <div className="flex flex-col">
                                <h3 className="text-base font-bold text-gray-800">Table Set</h3>
    ...
    />                            </div>
                            ...
                            <div className="flex flex-col">
                                <h3 className="text-base font-bold text-gray-800">Dining Table</h3>
    ...
    />                                </div>
                            ...
                            <div className="flex flex-col">
                                <h3 className="text-base font-bold text-gray-800">Chair</h3>
    ...
    />                                </div>
                            ...
                            <div className="flex flex-col">
                                <h3 className="text-base font-bold text-gray-800">Sofa</h3>
                                <p className="text-xs font-semibold text-gray-500 mt-0.5">Size: LG</p>
